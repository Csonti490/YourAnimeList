...
<head>
  ...
  <title>team02.project.scholaeu.hu / localhost | phpMyAdmin 5.2.1</title>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"4622733a42544a576c747860227b5b29",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"cookie",user:"team02"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=team02&table=YAL_CsontiXD">
    `team02`.`YAL_CsontiXD`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=YAL_AsdTroll">
    `team02`.`YAL_AsdTroll`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=YAL_Apropulya">
    `team02`.`YAL_Apropulya`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=users">
    `team02`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=statusorder">
    `team02`.`statusorder`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=news">
    `team02`.`news`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=newpass">
    `team02`.`newpass`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=messages">
    `team02`.`messages`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=friends_list">
    `team02`.`friends_list`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=team02&table=folista">
    `team02`.`folista`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i class="first"></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.dGVhbTAy" data-pos="0"></span>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGVhbTAy" data-vpath="cm9vdA==.dGVhbTAy." data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=team02"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=team02" title="Structure">team02</a>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGVhbTAyX3JvdW5kY3ViZQ==" data-vpath="cm9vdA==.dGVhbTAy.cm91bmRjdWJl" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=team02_roundcube"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=team02_roundcube" title="Structure">team02_roundcube</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4622733a42544a576c747860227b5b29">
